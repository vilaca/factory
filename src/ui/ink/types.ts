...
export type DisplayItem =
  ...
  | { kind: 'tool-call'; id: number; toolName: string; args: Record<string, unknown>; status?: 'ok' | 'denied' }
  | { kind: 'tool-result'; id: number; toolName: string; output: string; outputFull?: string; success: boolean; empty?: boolean }
