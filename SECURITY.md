...
- Risks already documented in the README's [Security Considerations](README.md#security-considerations) section (e.g. the Bash tool executes shell commands by design)
