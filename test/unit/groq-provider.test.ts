    ...
    await withServer((_req, res) => {
      ...
      res.end(JSON.stringify({
        data: [
          ...
          { id: 'meta-llama/llama-4-scout-17b-16e-instruct', object: 'model', owned_by: 'groq' },
          { id: 'groq/compound-mini', object: 'model', owned_by: 'groq' },
        ],
      }));
    }, async (baseUrl) => {
      ...
      assert.deepStrictEqual(provider.getModelPickerInfo('meta-llama/llama-4-scout-17b-16e-instruct'), {
